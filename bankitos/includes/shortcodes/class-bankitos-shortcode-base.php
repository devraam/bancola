    ...
    protected static function top_notice_from_query(): string {
        ...
        if (!empty($_GET['ok'])) {
            ...
            $map_ok = [
                ...
                'renuncia_aprobada'    => __('Solicitud aprobada. El socio ahora tiene rol de socio general y puede retirarse por su cuenta si cumple las condiciones de crédito.', 'bankitos'),
        ...
        $map = [
            ...
            'email_exists'    => __('Ese correo ya está registrado. Intenta iniciar sesión o recupera tu contraseña.', 'bankitos'),
            'crear'           => __('No pudimos crear tu cuenta. Intenta nuevamente.', 'bankitos'),
            'too_many_attempts' => __('Demasiados intentos. Espera unos minutos e inténtalo de nuevo.', 'bankitos'),
            ...
            'renuncia_credito_supera_rentabilidad' => __('No puedes retirarte: el saldo total de tus créditos activos supera tu total disponible (ahorros + intereses + multas).', 'bankitos'),
