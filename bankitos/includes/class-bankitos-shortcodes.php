...
class Bankitos_Shortcodes {
  ...
  public static function init(): void {
    ...
    $files = [
        ...
        'class-bankitos-shortcode-panel-finanzas.php',
        'class-bankitos-shortcode-panel.php',
        'class-bankitos-shortcode-mobile-menu.php',
        'class-bankitos-shortcode-crear-banco.php',
        'class-bankitos-shortcode-aporte-form.php',
        'class-bankitos-shortcode-credit-request.php',
        'class-bankitos-shortcode-credit-summary.php',
        'class-bankitos-shortcode-credit-review.php',
        'class-bankitos-shortcode-tesorero-desembolsos.php',
        'class-bankitos-shortcode-tesorero-creditos.php',
        'class-bankitos-shortcode-veedor-creditos.php',
    ...
    $classes = [
        ...
        'Bankitos_Shortcode_Panel_Finanzas',
        'Bankitos_Shortcode_Panel',
        'Bankitos_Shortcode_Mobile_Menu',
        'Bankitos_Shortcode_Crear_Banco',
        'Bankitos_Shortcode_Aporte_Form',
        'Bankitos_Shortcode_Credit_Request',
        'Bankitos_Shortcode_Credit_Summary',
        'Bankitos_Shortcode_Credit_Review',
        'Bankitos_Shortcode_Tesorero_Desembolsos',
        'Bankitos_Shortcode_Tesorero_Creditos',
        'Bankitos_Shortcode_Veedor_Creditos',
